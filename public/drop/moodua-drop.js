...
root.querySelectorAll('.section-heading,.catalog-heading,.builder-heading,.faq-heading,.video-teaser-frame,.accordion-item,.product-card,.builder-shell,.faq-item,.charity-card,.final-cta-copy').forEach((element) => { element.classList.add('reveal'); revealObserver.observe(element); });
