(function (root, factory) {
  ...
  function summarizeCollection(items) {
    ...
    const itemsWord = pluralizeUk(items.length, 'виріб', 'вироби', 'виробів');
    const unitsWord = pluralizeUk(total, 'одиниця', 'одиниці', 'одиниць');
    return `${items.length} ${itemsWord} · ${total} ${unitsWord}\n${list}`;
  }
